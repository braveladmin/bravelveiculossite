        ...
        {step === 0 && (
          <div className="space-y-5">
            ...
            <button
              ...
              style={{
                backgroundColor: batchMode ? "rgba(204,17,17,0.1)" : SURF2,
                border: `1px solid ${batchMode ? "rgba(204,17,17,0.35)" : BORDER}`,
              }}
            >
              ...
              <>
                {batchDone && (
                  <div
                    className="flex items-center gap-3 p-3 rounded-xl"
                    style={{
                      backgroundColor: batchErrors === 0 ? "rgba(37,211,102,0.1)" : "rgba(204,17,17,0.1)",
                      border: `1px solid ${batchErrors === 0 ? "rgba(37,211,102,0.3)" : "rgba(204,17,17,0.3)"}`,
                    }}
                  >
                    {batchErrors === 0
